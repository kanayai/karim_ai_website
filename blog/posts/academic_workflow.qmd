...
If you work across multiple machines—say, a powerful Office Desktop and a personal Laptop—you face a dilemma: Cloud storage (OneDrive/Dropbox) is great for PDFs but ruins code history. Git is perfect for code but chokes on 2GB datasets.
...
::: {.folder-tree}
<!-- Teaching Section -->
<div class="teaching-group">📂 Teaching/</div>
<div style="padding-left: 20px;">📂 ma101_linear_algebra/</div>
<div style="padding-left: 40px;">📄 lectures.qmd</div>
<div style="padding-left: 40px;">📄 script_week1.R</div>
<div style="padding-left: 40px;">📄 _quarto.yml</div>

<br>
<!-- Research Section -->
<div class="research-group">📂 Research/</div>
<div style="padding-left: 20px;">📂 climate_change_paper/</div>
<div style="padding-left: 40px;">📄 analysis.ipynb</div>
<div style="padding-left: 40px;">📄 manuscript.tex</div>
:::
...
<div class="teaching-group">📂 Teaching/</div>
<div style="padding-left: 20px;">📂 ma101_linear_algebra/</div>
<div style="padding-left: 40px;">📄 scanned_textbook.pdf</div>
<div style="padding-left: 40px;">📄 student_grades.xlsx</div>

<br>
<!-- Research Section -->
<div class="research-group">📂 Research/</div>
<div style="padding-left: 20px;">📂 climate_change_paper/</div>
<div style="padding-left: 40px;">📄 raw_weather_data.csv <span class="dim">(2GB)</span></div>
<div style="padding-left: 40px;">📄 final_proof.pdf</div>
:::
...
echo -e "\n🎉 Sync Complete! Safe to switch computers."
```
...
**📄 .Renviron (Save in your Home folder)**
